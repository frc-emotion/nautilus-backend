...
class RegisterSchema(BaseModel):
    ...
    student_id: int = Field("N/A", description="7-character student ID (default is 'N/A')")  # e.g., 1234567
    ...
    def check_student_id(cls, value: int) -> int:
...
class UpdateUserSchema(BaseModel):
    ...
    student_id: int = Field(None, description="7-character student ID")
